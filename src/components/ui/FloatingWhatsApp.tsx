...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      aria-label="Message DTB LAB on WhatsApp"
      data-cursor-hover
      className={[
        'fixed bottom-6 right-6 z-50 flex items-center justify-center',
        'w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg',
        'transition-all duration-300 ease-lab hover:scale-110 hover:shadow-[0_0_24px_rgba(37,211,102,0.5)]',
